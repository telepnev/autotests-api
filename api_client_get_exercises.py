...
# 5 получаем упражнения по курсу

get_exercises_request = exercises_client.get_exercises_list(create_course_response['course']['id'])
print('Get exercises data: ', get_exercises_request)
