...
# 5 обновляем упражнение

update_exercises_request = UpdateExercisesRequestDict(
    title= "Python + Update",
    maxScore= 90,
    minScore= 4,
    orderIndex= 11,
...
update_exercises_response = exercises_client.update_exercise(create_exercises_response['exercise']['id'],update_exercises_request)
print('Update exercise data: ', update_exercises_response)